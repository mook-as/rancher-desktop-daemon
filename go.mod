module github.com/rancher-sandbox/rancher-desktop-daemon
...
require (
	...
	k8s.io/endpointslice v0.35.2 // indirect
	k8s.io/externaljwt v0.35.2 // indirect
	k8s.io/gengo/v2 v2.0.0-20250922181213-ec3ebc5fd46b // indirect
	k8s.io/kms v0.35.2 // indirect
	k8s.io/kube-controller-manager v0.35.2 // indirect
	k8s.io/kube-openapi v0.0.0-20250910181357-589584f1c912 // indirect
	k8s.io/kube-proxy v0.35.2 // indirect
	k8s.io/kube-scheduler v0.35.2 // indirect
